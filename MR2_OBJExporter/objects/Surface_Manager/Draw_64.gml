...
if (draw_check28 == true){
	...
	draw_surface(vram28, p28_Window.left + 1, p28_Window.top + 1)
}
else{
...
if (draw_check29 == true){
	...
	draw_surface(vram29, p29_Window.left + 1, p29_Window.top + 1)
}
else{
...
if (draw_check30 == true){
	...
	draw_surface(vram30, p30_Window.left + 1, p30_Window.top + 1)
}
else{
...
if (draw_check31 == true){
	...
	draw_surface(vram31, p31_Window.left + 1, p31_Window.top + 1)
}
else{
