...
if (instance_exists(ImportTIM)){
	...
	if (alarm[0] != -1){
		...
		draw_text_transformed(x + 178, y + 13,string("Processing..."), .5, .5, 0);
		draw_set_colour($A39566);
		draw_text_transformed(x + 238, y + 13,string("(This might take a few seconds)"), .5, .5, 0);
	}
	else{
